...
/**
 * TODO(gianm): Ensure following statement is correct
 * DruidRel that uses a "table" or "lookup" dataSource.
 */
public class DruidQueryRel extends DruidRel<DruidQueryRel>
{
  ...
  {
    return planner.getCostFactory().makeCost(partialQuery.estimateCost(COST_BASE), 0, 0);
  }
}
