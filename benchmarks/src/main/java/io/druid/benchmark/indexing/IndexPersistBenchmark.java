...
public class IndexPersistBenchmark
{
  ...
  {
    File tmpFile = File.createTempFile("IndexPersistBenchmark-" + System.currentTimeMillis(), "TEMPFILE");
    tmpFile.delete();
    tmpFile.mkdirs();
  ...
  {
    File tmpFile = File.createTempFile("IndexPersistBenchmark-V9-" + System.currentTimeMillis(), "TEMPFILE");
    tmpFile.delete();
    tmpFile.mkdirs();
    System.out.println(tmpFile.getAbsolutePath() + " isFile: " + tmpFile.isFile() + " isDir:" + tmpFile.isDirectory());
    tmpFile.deleteOnExit();
