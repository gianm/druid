...
public class JoinAndLookupBenchmark
{
  ...
  Segment hashJoinLookupStringKeySegment = null;
  Segment hashJoinLookupLongKeySegment = null;
  Segment hashJoinIndexedTableStringKeySegment = null;
  Segment hashJoinIndexedTableLongKeySegment = null;
  VirtualColumns lookupVirtualColumns = null;
  ...
  public void setup() throws IOException
  {
    ...
    index = JoinTestHelper.createFactIndexBuilder(tmpDir, rows).buildMMappedIndex();
...
//                System.out.println("val (1) => " + lastValue);
              }
              cursor.advance();
            }
            return lastValue;
...
//              System.out.println("val (2) => " + selector.lookupName(lastValue));
              cursor.advance();
            }
