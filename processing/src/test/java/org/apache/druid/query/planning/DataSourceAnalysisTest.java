...
public class DataSourceAnalysisTest
{
  ...
  public void testTable()
  {
    ...
    Assert.assertTrue(analysis.isScanBased());
    Assert.assertTrue(analysis.isTableScanBased());
    ...
    Assert.assertEquals(Collections.emptyList(), analysis.getJoinClauses());
  }
  ...
  public void testLookup()
  {
    ...
    Assert.assertTrue(analysis.isScanBased());
    Assert.assertFalse(analysis.isTableScanBased());
  ...
  public void testJoinSimpleLeftLeaning()
  {
    ...
    Assert.assertEquals(
        ImmutableList.of(
            new JoinClause("1.", LOOKUP_LOOKYLOO, JoinType.INNER, joinClause("1.")),
            new JoinClause("2.", INLINE, JoinType.LEFT, joinClause("2.")),
            new JoinClause("3.", subquery(LOOKUP_LOOKYLOO), JoinType.FULL, joinClause("3."))
        ),
        analysis.getJoinClauses()
    );
  }
  ...
  public void testJoinSimpleRightLeaning()
  {
    ...
    Assert.assertEquals(
        ImmutableList.of(
            new JoinClause("3.", rightLeaningJoinStack, JoinType.RIGHT, joinClause("3."))
        ),
        analysis.getJoinClauses()
    );
  }
  ...
  public void testJoinOverTableSubquery()
  {
    ...
    Assert.assertFalse(analysis.isScanBased());
    Assert.assertFalse(analysis.isTableScanBased());
    Assert.assertFalse(analysis.isGlobal());
    Assert.assertFalse(analysis.isQuery());
    Assert.assertEquals(joinDataSource, analysis.getDataSource());
    ...
    Assert.assertEquals(
        ImmutableList.of(
            new JoinClause("1.", subquery(TABLE_FOO), JoinType.INNER, joinClause("1."))
        ),
        analysis.getJoinClauses()
    );
  }
  ...
  public void testJoinLookupToTable()
  {
    ...
    Assert.assertEquals(
        ImmutableList.of(
            new JoinClause("1.", TABLE_FOO, JoinType.INNER, joinClause("1."))
        ),
        analysis.getJoinClauses()
    );
  }
